...
const EmailPreview = ({ emailData }) => {
  ...
  const copyToClipboard = () => {
    const emailText = `Para: ${emailData.para || emailData.to || ''}\nAsunto: ${emailData.asunto || emailData.subject || ''}\n\n${emailData.cuerpo || emailData.body || ''}`;
  ...
  return (
    <div className="email-preview">
      ...
      <div className="email-field">
        ...
        <input 
          type="text" 
          value={emailData.para || emailData.to || ''} 
